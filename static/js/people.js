(function () {
  ...
  var orgData = {
    '2025-2026': [
      ...
      { name: 'Hannah Kim', role: 'Report Lead', tier: 2, initials: 'H.K', university: 'BU', division: 'Equity Research' },
      ...
      { name: 'Woojeong Youn', role: 'PD Lead', tier: 2, initials: 'W.Y', university: 'BC', division: 'PD/PR' },
      ...
      { name: 'Haeun Lee', role: 'Report Team', tier: 3, initials: 'H.L', university: 'NEU', division: 'Equity Research' },
  ...
  function cardHtml(person, size) {
    ...
    var avatarHtml = person.photo
      ? '<img src="/static/images/' + person.photo + '" alt="" class="rounded-full object-cover shrink-0 ' + avatarSize.replace(' text-xl', '').replace(' text-lg', '').replace(' text-sm', '') + '" width="64" height="64">'
