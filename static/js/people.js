(function () {
  ...
  var orgData = {
    '2025-2026': [
      ...
      { name: 'Hannah Kim', role: 'Case Study Lead', tier: 2, initials: 'H.K', university: 'BU', photo: '김해나_리포트팀_BU_3학년.jpg', division: 'Case Study' },
      { name: 'Kangmin Kim', role: 'Case Study Lead', tier: 2, initials: 'K.K', university: 'BU', photo: '김강민_리포트팀_BU_2학년.jpg', division: 'Case Study' },
      { name: 'Joonha Kwon', role: 'Case Study Lead', tier: 2, initials: 'J.K', university: 'BC', photo: '권준하_리포트팀_BC_3학년.JPG', linkedin: 'https://www.linkedin.com/in/joonha-kwon/', division: 'Case Study' },
      ...
      { name: 'Eugene Kim', role: 'Report Team', tier: 3, initials: 'E.K', university: 'BC', photo: 'EugeneKim_CaseStudy_BC.jpeg', division: 'Equity Research' },
      { name: 'Phillip Yoon', role: 'Report Team', tier: 3, initials: 'P.Y', university: 'BC', photo: 'PhillipYoon_CaseStudy_BC.jpeg', division: 'Equity Research' },
      { name: 'Sunghyun An', role: 'Case Study Team', tier: 3, initials: 'S.A', university: 'BC', photo: 'SunghyunAn_Report_BC.png', division: 'Case Study' },
      { name: 'Eunjae Gil', role: 'Case Study Team', tier: 3, initials: 'E.G', university: 'BC', photo: 'EunjaeGil_Report_BC.jpg', division: 'Case Study' },
      { name: 'Dongwook Kim', role: 'Case Study Team', tier: 3, initials: 'D.K', university: 'BU', photo: 'DongwookKim_Report_BU.jpeg', division: 'Case Study' },
      { name: 'Ethan Kim', role: 'Case Study Team', tier: 3, initials: 'E.K', university: 'BC', photo: 'EthanKim_Report_BC.JPG', division: 'Case Study' },
      { name: 'Hyunsoo Kim', role: 'Case Study Team', tier: 3, initials: 'H.K', university: 'BU', photo: 'HyunsooKim_Report_BU.jpg', division: 'Case Study' },
      { name: 'Donghyun Lee', role: 'Case Study Team', tier: 3, initials: 'D.L', university: 'BU', photo: 'DonghyunLee_Report_BU.jpg', division: 'Case Study' },
      { name: 'Haeun Lee', role: 'Case Study Team', tier: 3, initials: 'H.L', university: 'NEU', photo: 'HaeunLee_Report_NEU.jpeg', division: 'Case Study' },
      { name: 'Ryan Lee', role: 'Case Study Team', tier: 3, initials: 'R.L', university: 'BC', photo: 'RyanLee_Report_BC.jpeg', division: 'Case Study' },
      { name: 'Yoonjun Song', role: 'Case Study Team', tier: 3, initials: 'Y.S', university: 'BU', photo: 'YoonjunSong_Report_BU.jpeg', division: 'Case Study' },
      { name: 'Eugene Kim', role: 'Case Study Team', tier: 3, initials: 'E.K', university: 'BC', photo: 'EugeneKim_CaseStudy_BC.jpeg', division: 'Case Study' },
      { name: 'Phillip Yoon', role: 'Case Study Team', tier: 3, initials: 'P.Y', university: 'BC', photo: 'PhillipYoon_CaseStudy_BC.jpeg', division: 'Case Study' },
      ...
      { name: 'Chaeah Son', role: 'Investment Team', tier: 3, initials: 'C.S', university: 'NEU', photo: 'ChaeahSon_Investment_NEU.jpeg', division: 'Investment' },
      { name: 'Dain Choi', role: 'Investment Team', tier: 3, initials: 'D.C', university: 'NEU', photo: 'DainChoi_Investment_NEU.jpeg', division: 'Investment' },
      { name: 'Hyunmin Choi', role: 'Investment Team', tier: 3, initials: 'H.C', university: 'BU', photo: 'HyunminChoi_Investment_BU.jpeg', division: 'Investment' },
      { name: 'Joon Yang', role: 'Investment Team', tier: 3, initials: 'J.Y', university: 'BU', photo: 'JoonYang_Investment_BU.jpg', division: 'Investment' },
